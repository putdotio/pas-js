...
The npm package uses Trusted Publishing from GitHub Actions. On npm, configure owner `putdotio`, repository `pas-js`, workflow `ci.yml`, and Environment named `release` for the package.
